...
class TraceCode extends BaseTraceCode
{
    ...
    const PATCH_PUBLIC_TOKEN_INPUT_PARAMS                           = 'PATCH_PUBLIC_TOKEN_INPUT_PARAMS';
    const PATCH_PUBLIC_TOKEN_REQUEST_SUCCESS                        = 'PATCH_PUBLIC_TOKEN_REQUEST_SUCCESS';
    const PATCH_PUBLIC_TOKEN_REQUEST_NOT_FOUND                      = 'PATCH_PUBLIC_TOKEN_REQUEST_NOT_FOUND';
    const PATCH_PUBLIC_TOKEN_REQUEST_FAILED                         = 'PATCH_PUBLIC_TOKEN_REQUEST_FAILED';
    const PATCH_PUBLIC_TOKEN_REQUEST_NUM_RECORDS                    = 'PATCH_PUBLIC_TOKEN_REQUEST_NUM_RECORDS';
    ...
    const PATCH_OAUTH_IDENTIFIER_IN_EDGE                           =  'PATCH_OAUTH_IDENTIFIER_IN_EDGE';
